...
function EditBook() {
    ...
    const fetchBook = async () => {
      try {
        ...
        setBookData({
          ...
          publishedDate: book.publishedDate.split('T')[0], // Format date for input
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        navigate(`/books`); // Redirect to book details after successful update
      }
    } catch (err) {
  ...
  return (
    <div className="edit-book-page">
      {/* Hero Section */}
      <section className="edit-hero bg-primary text-white py-4">
        <div className="container py-4">
          <div className="row align-items-center">
            <div className="col-md-8">
              <h1 className="display-6 fw-bold mb-3">Edit Book</h1>
              <p className="mb-0">Update the details of {bookData.bookName}</p>
            </div>
                      ...
                      <div className="col-12 mt-4">
                        ...
                        >
                          {isSubmitting ? (
                            ...
                            <>
                              <i className="bi bi-save me-2"></i> Update Book
                            </>
                          )}
                        </button>
                        <button 
